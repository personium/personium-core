 ...
 */
public class DcJsonComplexObjectFormatParser extends DcJsonFormatParser implements FormatParser<OComplexObject> {

    /**
     * コンストラクタ.
     * @param s 設定情報
     */
    public DcJsonComplexObjectFormatParser(Settings s) {
        super(s);
        if (s == null) {
            returnType = null;
        } else {
