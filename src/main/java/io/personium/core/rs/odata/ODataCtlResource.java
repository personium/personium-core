...
public class ODataCtlResource {
    ...
    private void checkNonSupportLinks(String sourceEntity, String targetNavProp) {
        ...
        if ((sourceEntity.equals(ExtRole.EDM_TYPE_NAME)
                        && targetNavProp.equals(Relation.EDM_TYPE_NAME)) //NOPMD -To maintain readability
                || (sourceEntity.equals(Relation.EDM_TYPE_NAME)
