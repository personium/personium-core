 ...
 * --------------------------------------------------
 * This code is based on Multistatus.java of wink-webdav, and some modifications
...
@XmlRootElement(namespace = "DAV:", name = "multistatus")
public class Multistatus {

    @XmlElement(namespace = "DAV:", name = "response", required = true)
