 ...
 * --------------------------------------------------
 * This code is based on Propertyupdate.java of wink-webdav, and some modifications
...
@XmlRootElement(namespace = "DAV:", name = "propertyupdate")
public class Propertyupdate {

    @XmlElements( {@XmlElement(namespace = "DAV:", name = "set", type = Set.class),
        @XmlElement(namespace = "DAV:", name = "remove", type = Remove.class)})
