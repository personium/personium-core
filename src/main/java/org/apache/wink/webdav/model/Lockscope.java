 ...
 * --------------------------------------------------
 * This code is based on Lockscope.java of wink-webdav, and some modifications
...
@XmlRootElement(namespace = "DAV:", name = "lockscope")
public class Lockscope {

    @XmlElement(namespace = "DAV:", name = "exclusive")
    protected Exclusive exclusive;
    @XmlElement(namespace = "DAV:", name = "shared")
