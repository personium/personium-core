...
import com.fujitsu.dc.core.model.impl.es.odata.EsODataProducer;
...
public final class ODataLinksResource {
    ...
    public Response createLink(
        ...
        OEntityId newTargetEntity =
                parseRequestUri(DcCoreUtils.createUriInfo(uriInfo, NUM_LEVELS_FROM_SVC_ROOT), reqBody);
    ...
    public Response getLinks(
        ...
        UriInfo uriInfo2 = DcCoreUtils.createUriInfo(uriInfo, NUM_LEVELS_FROM_SVC_ROOT);
