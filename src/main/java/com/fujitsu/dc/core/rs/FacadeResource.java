...
import com.fujitsu.dc.core.rs.cell.CellResource;
import com.fujitsu.dc.core.rs.unit.UnitCtlResource;
...
public class FacadeResource {
    ...
    static final String CROSSDOMAIN_XML = DcCoreUtils.readStringResource("crossdomain.xml", CharEncoding.UTF_8);
