...
public class AuthTest extends PersoniumTest {
    ...
    public final void C14_トークン認証リフレッシュトークンートランセル＿トークン発行のテスト() {
        try {
            ...
            assertEquals(rToken.getRoleList().get(0).toRoleInstanceURL(),
                rToken2.getRoleList().get(0).toRoleInstanceURL());
    ...
    public final void C13_スキーマ付きトークン認証リフレッシュトークンートランセル() {
        try {
            ...
            assertEquals(rToken1.getRoleList().get(0).toRoleInstanceURL(),
                rToken2.getRoleList().get(0).toRoleInstanceURL());
