...
public class FacadeResourceTest {
    ...
    public void facade_PathBased_InvalidUrlAccess_ShouldThrow_Exception() {
        ...
        this.assertFacadeThrowsPersoniumCoreException(accessUrlList, PersoniumCoreException.Common.INVALID_URL_AUTHORITY);
    }
    @Test
    ...
    private void assertFacadeThrowsPersoniumCoreException(URI[] accessUrlList, PersoniumCoreException expectedException) {
        for (URI accessUrl : accessUrlList) {
            UriInfo uriInfo = Mockito.mock(UriInfo.class);
            HttpServletRequest httpServletRequest = Mockito.mock(HttpServletRequest.class);
