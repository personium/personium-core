...
/**
 * PersoniumEngineSvcCollectionResource unit test classs.
 */
@RunWith(PowerMockRunner.class)
@PrepareForTest({ AccessContext.class })
@Category({ Unit.class })
public class PersoniumEngineSvcCollectionResourceTest {

    /** Target class of unit test. */
    private PersoniumEngineSvcCollectionResource engineSvcCollectionResource;
    ...
    public void delete_Normal() {
        ...
        // Mock settings
        engineSvcCollectionResource = spy(new PersoniumEngineSvcCollectionResource(null, null));
        DavRsCmp davRsCmp = mock(DavRsCmp.class);
        engineSvcCollectionResource.davRsCmp = davRsCmp;
        ...
        engineSvcCollectionResource.davCmp = davCmp;
        ...
        // Run method
        Response actual = engineSvcCollectionResource.delete(recursiveHeader);
    ...
    public void delete_Error_recursiveHeader_is_unexpected() {
        ...
        // Run method
        try {
            engineSvcCollectionResource.delete(recursiveHeader);
